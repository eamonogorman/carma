...
;###################################### chan 34 ################################
set_plot, 'ps'
device, file='test34.ps',/color, bits=24, /encapsulate, xsize=1.5, ysize=1.5, /inches
make_ct, ncolors=3
imag=b[60:380,60:380,34]
tvscl, imag<0.15
;
PLOTS, 0.10*321, 0.11*321, thick=2, color=2
PLOTS, 0.10*321+6.0*321*(0.0311526), 0.11*321, /CONTINUE, thick=2, color=1
xyouts,10,10,'6 arcsec', charthick=2.0, charsize=0.7, color=1
v=[rms[0]*(-2), rms[0]*2.0,rms[0]*4.0, rms[0]*6]
CONTOUR, imag, LEVELS = V, C_LINESTYLE = (V LT 0.0) , MAX_VALUE = 0.2, XSTYLE = 1, YSTYLE = 1, /noerase,c_colors=0, POSITION=[0.0, 0.0, 1.0, 1.0], c_thick=1.5, /overplot
...
set_plot, 'ps'
device, file='test'+string(i,format='(g0.3)')+'.ps',/color, bits=24, /encapsulate, xsize=1.5, ysize=1.5, /inches
make_ct, ncolors=3
;
;device, decomposed=0
;
...
;###################################### chan 41 ################################
set_plot, 'ps'
device, file='test41.ps',/color, bits=24, /encapsulate, xsize=1.5, ysize=1.5, /inches
make_ct, ncolors=3

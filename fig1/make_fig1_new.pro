...
flx64c=flx64
flx32c=flx32
restore, 'd_4_combine_spectra.sav'
flx64d=flx64
flx32d=flx32
restore, 'e_4_combine_spectra.sav'
flx64e=flx64
flx32e=flx32
;
!p.multi=[0,1,2]
...
!p.font=0
;
device, file='/home/Eamon/carma/apjl/fig1/fig1_new.eps',/color, bits=24, encaps=0
device, ysize=26.0
device, xsize=19.0
...
vline, -16, thick=6, linestyle=2
vline, +13, thick=6, linestyle=2
;
...
xyouts, -28.0, 5.8, 'D config', charthick=6, charsize=1.4
vline, -10, thick=6, linestyle=2
vline, -16, thick=6, linestyle=2
vline, +13, thick=6, linestyle=2
;

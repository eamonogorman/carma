...
!p.font=0
set_plot, 'ps'
device, file='chan'+i+'new.ps',/color, bits=24, /encapsulate, xsize=1.5, ysize=1.5, /inches
;
...
tvscl, b[*,*,i]<0.2
make_ct, ncolors=4
xyouts,0.55,0.9,'-17.9 km s!u-1!n', charthick=2.0, charsize=0.7, color=1
		;
...
;
PLOTS, 0.15, 0.12, thick=2, color=1
PLOTS, 0.15+6.0*(0.022222), 0.12, /CONTINUE, thick=2, color=1	
xyouts,0.06,0.05,'6 arcsec', charthick=2.0, charsize=0.7, color=1
